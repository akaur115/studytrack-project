...
import { t as require_react_dom } from "./react-dom-BmMd8IS7.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { $t as useLocation, nn as useNavigate, sn as useParams } from "./development-U0_bJkyK.js";
import { t as require_client } from "./react-dom_client.js";
//#region node_modules/@clerk/react-router/dist/utils/errors.js
...
`);
createErrorMessage(`Missing domain and proxyUrl. A satellite application needs to specify a domain or a proxyUrl`);
createErrorMessage(`
...
`);
//#endregion
//#region node_modules/@clerk/react-router/dist/utils/assert.js
function warnForSsr(val) {
	if (!val || !val.__internal_clerk_state) console.warn(noClerkStateError);
}
function assertValidClerkState(val) {
	if (!val) throw new Error(noClerkStateError);
	if (!!val && !val.__internal_clerk_state) throw new Error(invalidClerkStatePropError);
}
function assertPublishableKeyInSpaMode(key) {
	if (!key || typeof key !== "string") throw new Error(publishableKeyMissingErrorInSpaMode);
}
/**
...
*/
var isSpaMode = () => {
	if (typeof window !== "undefined" && typeof window.__reactRouterContext?.isSpaMode !== "undefined") return window.__reactRouterContext.isSpaMode;
};
//#endregion
...
//#endregion
//#region node_modules/@clerk/react-router/dist/utils/env.js
...
//#endregion
//#region node_modules/@clerk/react-router/dist/client/ReactRouterOptionsContext.js
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var ClerkReactRouterOptionsCtx = import_react.createContext(void 0);
ClerkReactRouterOptionsCtx.displayName = "ClerkReactRouterOptionsCtx";
var ClerkReactRouterOptionsProvider = (props) => {
	const { children, options } = props;
	return /* @__PURE__ */ import_react.createElement(ClerkReactRouterOptionsCtx.Provider, { value: { value: options } }, children);
};
//#endregion
//#region node_modules/@clerk/react-router/dist/client/useAwaitableNavigate.js
...
var SignIn$1 = withClerk(({ clerk, component, fallback, ...props }) => {
...
var SignUp$1 = withClerk(({ clerk, component, fallback, ...props }) => {
	const shouldShowFallback = useWaitForComponentMount(component) === "rendering" || !clerk.loaded;
	const rendererRootProps = { ...shouldShowFallback && fallback && { style: { display: "none" } } };
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, shouldShowFallback && fallback, clerk.loaded && /* @__PURE__ */ import_react.createElement(ClerkHostRenderer, {
		component,
...
var UserProfile$1 = Object.assign(_UserProfile, {
...
var OrganizationProfile$1 = Object.assign(_OrganizationProfile, {
...
*/
var versionSelector = (clerkJSVersion, packageVersion = "6.25.11") => {
...
var clerkUIScriptUrl = (opts) => {
	...
	const version = versionSelector(__internal_clerkUIVersion, "1.27.0");
...
//#endregion
//#region node_modules/@clerk/react/dist/ClerkProvider-Bm8khY4-.mjs
...
var IsomorphicClerk = class IsomorphicClerk {
	...
	*/
	...
	constructor(options) {
		...
		if (!this.options.sdkMetadata) this.options.sdkMetadata = SDK_METADATA$1;
...
function computeReactVersionCompatibility() {
	try {
		return isVersionCompatible(import_react.version, [
			[
				18,
				0,
				-1,
...
function ClerkProviderBase$1(props) {
...
var ClerkProvider$1 = withMaxAllowedInstancesGuard(ClerkProviderBase$1, "ClerkProvider", multipleClerkProvidersError);
...
*/
var InternalClerkProvider = ClerkProvider$1;
//#endregion
//#region node_modules/@clerk/react-router/dist/client/ReactRouterClerkProvider.js
var SDK_METADATA = {
...
function ClerkProviderBase({ children, ...rest }) {
	...
	return /* @__PURE__ */ import_react.createElement(ClerkReactRouterOptionsProvider, { options: mergedProps }, /* @__PURE__ */ import_react.createElement(InternalClerkProvider, {
...
var ClerkProvider = ({ children, loaderData, ...opts }) => {
	...
	return /* @__PURE__ */ import_react.createElement(ClerkProviderBase, {
		...opts,
		clerkState
	}, children);
};
//#endregion
//#region node_modules/@clerk/react-router/dist/client/usePathnameWithoutSplatRouteParams.js
...
if (globalThis.__clerkSharedModules) {
	...
	if (existingVersion && existingVersion !== import_react.version) console.warn(`[@clerk/ui/register] React version mismatch detected. Already registered: ${existingVersion}, current import: ${import_react.version}. This may cause issues with the shared @clerk/ui variant.`);
...
//#endregion
//#region node_modules/@clerk/react-router/dist/client/uiComponents.js
var UserProfile = Object.assign((props) => {
	const path = usePathnameWithoutSplatRouteParams();
	return /* @__PURE__ */ import_react.createElement(UserProfile$1, useRoutingProps("UserProfile", props, { path }));
}, { ...UserProfile$1 });
var OrganizationProfile = Object.assign((props) => {
	const path = usePathnameWithoutSplatRouteParams();
	return /* @__PURE__ */ import_react.createElement(OrganizationProfile$1, useRoutingProps("OrganizationProfile", props, { path }));
}, { ...OrganizationProfile$1 });
var SignIn = (props) => {
	const path = usePathnameWithoutSplatRouteParams();
	return /* @__PURE__ */ import_react.createElement(SignIn$1, useRoutingProps("SignIn", props, { path }));
};
var SignUp = (props) => {
	const path = usePathnameWithoutSplatRouteParams();
	return /* @__PURE__ */ import_react.createElement(SignUp$1, useRoutingProps("SignUp", props, { path }));
};
//#endregion
//#region node_modules/@clerk/react-router/dist/index.js
